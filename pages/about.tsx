        ...
        <div className={styles.description}>
          ...
          <div className={styles.about}>
            <p>
              ...
              Experienced, as a full-stack developer, in maintaining both front-end and back-end web applications. 
              Strong problem-solving skills and the ability to effectively communicate
