        ...
        <div className={styles.description}>
          ...
          <section className="dark:bg-gray-900">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 className="mb-2 text-4xl tracking-tight font-extrabold text-center text-gray-800 dark:text-white">{"Contact Me"}</h2>
                <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">{"I'd love to hear from you"}</p>
                <form className="space-y-8" onSubmit={(e) => formSubmit(e)}>
                    <div>
                        <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-800 dark:text-gray-300">{"Your Email"}</label>
                        <input 
                          type="email" 
                          id="email" 
                          value={email} 
                    ...
                    <div>
                        <label htmlFor="subject" className="block mb-2 text-sm font-medium text-gray-800 dark:text-gray-300">{"Subject"}</label>
                        <input 
                          type="text" 
                          id="subject" 
                          value={subject} 
                    ...
                    <div className="sm:col-span-2">
                        <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-800 dark:text-gray-400">{"Your Message"}</label>
                        <textarea 
                          id="message" 
                          rows={6} 
                          value={message} 
