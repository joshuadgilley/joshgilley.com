...
export default function Layout({ children }: { children: any }) {
  ...
  const setCurrent = (name: string) => {
    navigation = navigation.map((item) => {
      item.current = item.name === name ? true : false;
      return item;
    });
    setCurrentName(name);
  }
      ...
      <Disclosure as="nav" className="bg-gray-800">
         ...
         <footer className="bottom-0 w-full bg-white dark:bg-gray-900">
          <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Joshua Gilley</a>. All Rights Reserved.
              </span>
