...
const BlogHeaderComponent: FC<Props> = ({
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <h1 className="mb-4 text-4xl w-8/10 font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">
        {title}
      </h1>
      <img className={styles.wrapperImage} src={mainImageUrl} />
      <p className="mb-6 mt-2 text-lg font-normal text-gray-500 lg:text-xl">
